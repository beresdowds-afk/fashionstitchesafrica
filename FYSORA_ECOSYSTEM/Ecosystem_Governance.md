...
- **FYSORA FASHN** – Core platform, master account authority, system of record, revenue engine, marketplace, commerce platform, governance authority.Can register all categories of users: customers, Tailors, Designers, Organizations, Super Admin.
- **iFYSORA** – Anthropometric measurement platform and professional onboarding gateway.Can register Tailors, Designers, Organizations. Registration of Customers and super Admin is prohibited.
- **FYSORA Companion** – Consumer onboarding gateway and premium feature showcase. Can register Customers only. Registration of Tailors, Designers, Organizations and Super Admin is prohibited 
...
- **FYSORA Companion**: Consumer Acquisition, Marketing Gateway, Premium Feature Showcase, Simplified User Experience.
...
Users must explicitly approve measurement sharing before professionals gain access.
...
4. Verified Fashion Organization
...
- Companion and iFYSORA must redirect dispute workflows to FYSORA FASHN services.
...
## Success Criteria
1. Users can enter through approved PWA and automatically receive a FYSORA FASHN account.
...
6. No direct FYSORA Companion ↔ iFYSORA communication exists.
